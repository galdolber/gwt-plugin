      ...
      (try
        (binding [eval/*pump-in* false]
          (eval/eval-in
           ...
           (subprocess-form compile-path files javac-opts show-out)))
        (catch Exception e
...
compilation of Clojure source; change :prep-tasks to alter this."
  [project & args]
  (run-javac-subprocess project args false)
  (run-javac-subprocess project args false)
  (run-javac-subprocess project args true))